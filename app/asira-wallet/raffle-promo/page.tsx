...
export default function RafflePromoPage() {
  ...
  useEffect(() => {
    setTickets(Number(localStorage.getItem("asira_raffle_tickets") || "0"));
  }, []);

  function buyTicket() {
    const price = 20;
    const balance = Number(localStorage.getItem("asira_wallet_balance") || "0");
    ...
    localStorage.setItem("asira_raffle_tickets", updatedTickets.toString());
