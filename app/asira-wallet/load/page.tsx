  ...
  const networks = [
    {
      name: "GCash",
      color: "bg-blue-500",
      route: "/asira-wallet/load/gcash",
    },
    {
      name: "Smart",
      color: "bg-green-500",
      route: "/asira-wallet/load/smart",
    },
    {
      name: "TNT",
      color: "bg-yellow-400",
      route: "/asira-wallet/load/tnt",
    },
    {
      name: "Globe",
      color: "bg-blue-700",
      route: "/asira-wallet/load/globe",
    },
    {
      name: "TM",
      color: "bg-cyan-500",
      route: "/asira-wallet/load/tm",
    },
    {
      name: "DITO",
      color: "bg-red-500",
      route: "/asira-wallet/load/dito",
    },
  ];
