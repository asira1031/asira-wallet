...
export default function CryptoPage() {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("asira_crypto_balances");
    ...
    <main className="min-h-screen bg-[#f7f7f7] px-6 py-8 text-black">
      <div className="mx-auto max-w-sm">
        ...
        <div className="rounded-3xl bg-black p-6 text-white shadow-sm">
          <p className="text-sm text-white/50">Asira Crypto Wallet</p>
              ...
              <button
                ...
                onClick={() => {
                  const routes: Record<string, string> = {
                    "Buy Crypto": "/asira-wallet/crypto/buy",
                    "Sell Crypto": "/asira-wallet/crypto/sell",
                    "Send Crypto": "/asira-wallet/crypto/send",
                    "Receive Crypto": "/asira-wallet/crypto/receive",
                  };
        ...
        <div className="mt-6 rounded-3xl bg-white p-5 shadow-sm">
          ...
          <p className="mt-3 break-all rounded-2xl bg-gray-100 p-4 text-sm text-gray-600">
            0xASIRA000000000000000000000000000000000000
          </p>
